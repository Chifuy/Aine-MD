...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    conn.sendHydrated(m.chat, text.trim(), '© Origami-Bot', await (await fetch(fla + `%name`)).buffer(), 'https://instagram.com/origami_bot', 'Instagram Bot', '+62 857-4754-3536', 'Owner Number', [
      ['Donate', '/donasi'],
      ['Sewa', '/sewa'],
      ['Owner', '/owner']
    ], m)
